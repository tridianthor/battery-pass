...
def get_battery(pk=None, code=None, chart_width = 300, chart_width_wide=350, chart_height = 300):
    if pk is None and code is None:
        raise Exception("No primary key or code provided")
...
def summary(request, pk=None, code=None):
    context = get_battery(pk=pk, chart_width=250, chart_width_wide=550, chart_height=300)
